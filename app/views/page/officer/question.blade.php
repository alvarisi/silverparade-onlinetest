			...
			<div class="small-12 large-8 end columns">
				<div class="row">
					<div class="panel side-content">
						...
						<div class="row">
							<div class="columns">
								<a href="{{ URL::to('competition/question/add') }}" class="button tiny">+&nbsp; Tambahkan</a>
							</div>
						</div>
						<table>
							<thead>
								<tr>
									...
									<th class="large-3">Pertanyaan</th>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="{{URL::to('/competition/question/edit/'.$row->id)}}"><i class="fi-pencil"></i></a>
										<a href="{{URL::to('/competition/question/info/'.$row->id)}}"><i class="fi-info"></i></a>
										<a href="{{URL::to('/competition/question/destroy/'.$row->id)}}"><i class="fi-trash"></i></a>
									</td>
								</tr>
								@endforeach
							</tbody>
