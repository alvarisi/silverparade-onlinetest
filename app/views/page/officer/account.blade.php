				...
				<div class="row">
					<div class="panel side-content">
						...
						<div class="row">
							<div class="large-12 columns">
								<table>
									...
									<tr>
										<td>Password</td>
										<td>:</td>
										<td><a href="{{ URL::to('officer/account/changepassword') }}" class="button tiny secondary">Ganti Password</a></td>
									</tr>
									<tr>
										<td>Email</td>
										<td>:</td>
							...
							<div class="columns">
								<a href="{{ URL::to('officer/account/edit') }}" class="button alert radius tiny"><i class='fi-pencil'></i>&nbsp;Edit</a>
							</div>
						</div>
